...
const std::vector<Move>& ChessCards::movesFor(CardType aType) {
...
const char* ChessCards::name(CardType aType) {
...
ChessCards::ChessCards(CardType aType)
    : mType(aType)
{
}

void ChessCards::show() const {
...
std::array<ChessCards::CardType, 5> ChessCards::getInitialHand(std::mt19937& rng) {
