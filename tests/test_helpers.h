...
public:
    ...
    Board& cards(CurrentCard::CardType a1, CurrentCard::CardType a2,
                 CurrentCard::CardType b1, CurrentCard::CardType b2,
                 CurrentCard::CardType side) {
        mNode.m_cards.set(Cards::CardA1, a1);
        mNode.m_cards.set(Cards::CardA2, a2);
        mNode.m_cards.set(Cards::CardB1, b1);
        mNode.m_cards.set(Cards::CardB2, b2);
        mNode.m_cards.set(Cards::CardExchange, side);
        return *this;
    }
